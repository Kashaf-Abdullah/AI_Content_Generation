...
// import { DEMO_MODE, DEMO_CONFIG } from '../config/demoConfig'
...
//         subscription: DEMO_CONFIG.user.subscription,
//         usageCount: DEMO_CONFIG.user.usageCount,
//         dailyLimit: DEMO_CONFIG.user.dailyLimit,
...
//           minute: '2-digit'
//         }),
//         postsGenerated: DEMO_CONFIG.stats.totalPosts,
...
//             description: 'In live mode, your profile would be saved',
//             status: 'success',
//             duration: 3000,
//           })
//           setEditing(false)
...
//       toast({
//         title: 'Demo Mode',
//         description: 'In live mode, this would redirect to Stripe checkout',
//         status: 'info',
//         duration: 3000,
//       })
//     } else {
...
//           <AlertIcon />
//           <Box>
//             <Text fontWeight="bold">Demo Profile</Text>
//             <Text fontSize="sm">You're viewing demo profile data</Text>
//           </Box>
//         </Alert>
//       )}
...
//                               ) : (
//                                 <Badge colorScheme="yellow" size="sm">Unverified</Badge>
//                               )}
//                             </HStack>
//                           )}
//                         </FormControl>
...
//                               leftIcon={profileData.subscription === 'pro' ? null : <FiCreditCard />}
//                             >
